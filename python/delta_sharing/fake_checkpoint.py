...
HAAAHAAAHAAAHAAAHAAAAJUqAABQQVIx""".strip().replace("\n", "")

__fake_checkpoint_byte_array_cache = None

def get_fake_checkpoint_byte_array():
    global __fake_checkpoint_byte_array_cache
    if __fake_checkpoint_byte_array_cache is None:
        __fake_checkpoint_byte_array_cache = base64.b64decode(FAKE_CHECKPOINT_B64_ENCODED.encode('ascii'))
    return __fake_checkpoint_byte_array_cache
