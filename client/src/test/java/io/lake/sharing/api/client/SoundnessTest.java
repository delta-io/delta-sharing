...
public class SoundnessTest {
  ...
  public void testHelloEndpoint() {
    ...
    Metastore glueMetastoreDefault =
        metastoreApi.createMetastore(
            new CreateMetastore()
                ...
                .credentials(
                    new StorageCredentials(
                        new SimpleAwsCredentials()
                            ...
                            .region("eu-west-1"))));
    Provider defaultS3GlueProvider =
    ...
    TableInfo table =
        tableApi.createTableInProvider(
