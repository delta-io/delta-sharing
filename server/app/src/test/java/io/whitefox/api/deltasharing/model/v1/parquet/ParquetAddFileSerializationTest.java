...
public class ParquetAddFileSerializationTest {
  ...
  ParquetAddFileSerializationTest() {
    om = new ObjectMapper();
  ...
  void deserialize() throws IOException {
    Assertions.assertEquals(object, om.reader().readValue(json, ParquetAddFile.class));
  }
