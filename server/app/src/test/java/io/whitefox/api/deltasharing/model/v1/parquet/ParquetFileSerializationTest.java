...
public class ParquetFileSerializationTest {
  ...
  void deserialize() throws IOException {
    Assertions.assertEquals(object, om.reader().readValue(json, ParquetFile.class));
  }
