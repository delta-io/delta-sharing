...
public class ParquetRemoveFileSerializationTest {

  String json =
      "{\"remove\":{\"url\":\"https://<s3-bucket-name>.s3.us-west-2.amazonaws.com/delta-exchange-test/table_cdf/date%3D2021-04-28/part-00000-591723a8-6a27-4240-a90e-57426f4736d2.c000.snappy.parquet?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Date=20210501T010655Z&X-Amz-SignedHeaders=host&X-Amz-Expires=900&X-Amz-Credential=AKIAISZRDL4Q4Q7AIONA%2F20210501%2Fus-west-2%2Fs3%2Faws4_request&X-Amz-Signature=dd5d3ba1a179dc7e239d257feed046dccc95000d1aa0479ea6ff36d10d90ec94\",\"id\":\"591723a8-6a27-4240-a90e-57426f4736d2\",\"partitionValues\":{\"date\":\"2021-04-28\"},\"size\":573,\"timestamp\":1652140800000,\"version\":1,\"expirationTimestamp\":1652144400000}}";

  ParquetRemoveFile object = ParquetRemoveFile.builder()
      .remove(ParquetRemoveFile.Remove.builder()
          .url(
  ...
  ParquetRemoveFileSerializationTest() {
    om = new ObjectMapper();
  ...
  void deserialize() throws IOException {
    Assertions.assertEquals(object, om.reader().readValue(json, ParquetRemoveFile.class));
  }
