...
public class ProvidersApiImpl implements ProvidersApi {
    ...
    @Override
    public CompletionStage<Response> createTableInProvider(String providerName, CreateTableInput createTableInput) {
        Response res = Response.ok().build();
        return CompletableFuture.completedFuture(res);
    }
    ...
    @Override
    public CompletionStage<Response> deleteTableInProvider(String providerName, String tableName, String force) {
        Response res = Response.ok().build();
        return CompletableFuture.completedFuture(res);
    }
    ...
    @Override
    public CompletionStage<Response> patchTableInProvider(String providerName, String tableName, PatchTableInput patchTableInput) {
        Response res = Response.ok().build();
        return CompletableFuture.completedFuture(res);
    }
