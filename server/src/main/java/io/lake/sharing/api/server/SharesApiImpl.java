...
import io.lake.sharing.api.server.model.AddRecipientToShareRequest;
import io.lake.sharing.api.server.model.CreateShareInput;
import io.lake.sharing.api.server.model.TableReference;
...
public class SharesApiImpl implements SharesApi {
    ...
    @Override
    public CompletionStage<Response> addRecipientToShare(String share, AddRecipientToShareRequest addRecipientToShareRequest) {
        Response res = Response.ok().build();
        return CompletableFuture.completedFuture(res);
    }

    @Override
    public CompletionStage<Response> addTableToSchema(String share, String schema, TableReference tableReference) {
        Response res = Response.ok().build();
        return CompletableFuture.completedFuture(res);
    }
    ...
    @Override
    public CompletionStage<Response> deleteTableFromSchema(String share, String schema, String table) {
        Response res = Response.ok().build();
        return CompletableFuture.completedFuture(res);
    }
